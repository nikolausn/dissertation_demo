...
recipe(r1_parallel_violation_4,3,p3,0).
recipe(r1_parallel_violation_4,4,p4,3).
recipe(r1_parallel_violation_4,5,p5,4).
recipe(r1_parallel_violation_4,6,p6,5).
recipe(r1_parallel_violation_4,7,p13,5).
recipe(r1_parallel_violation_4,8,p8,2).
recipe(r1_parallel_violation_4,9,p9,8).
recipe(r1_parallel_violation_4,10,p10,6).
recipe(r1_parallel_violation_4,10,p10,9).
recipe(r1_parallel_violation_4,10,p10,1).
