...
def baseline_clean_average(airbnb_pd):
    ...
    def clean_duplicate_id(df):
        ...
        #df.loc[df.id.apply(lambda x:x in dup_ids.id.values),"id_flag"] = 1
        df.loc[df.id.duplicated(),"id_flag"] = 1
        return df
    ...
    def clean_host_id(df):
        ...
        df.loc[df.host_id.apply(lambda x:x in dup_host_id.host_id.values),"host_id_flag"] = 1
        return airbnb_pd
    ...
    def clean_neighbourhood(df):
        ...
        df.loc[df.id.apply(lambda x:x in neighbourhood_check.id.values),"neighbourhood"] = "other"
        return df
    ...
    def clean_latitude(df):
        ...
        average = df[~df.id.isin(lat_check_pd.id.values)].latitude.apply(lambda x:float(x)).mean()
        df.loc[df.id.isin(lat_check_pd.id.values),"latitude"] = average   
        return df
    ...
    def clean_longitude(df):
        ...
        average = df[~df.id.isin(lon_check_pd.id.values)].longitude.apply(lambda x:float(x)).mean()
        df.loc[df.id.isin(lon_check_pd.id.values),"longitude"] = average  
        return df
    ...
    def clean_room_type(df):
        ...
        df.loc[df.id.apply(lambda x:x in room_type_pd.id.values),"room_type"] = "other"    
        return df
    ...
    def clean_minimum_nights(df):
        ...
        #df.loc[df.id.apply(lambda x:x in min_check_pd.id.values),"minimum_nights_flag"] = 1
        average = df[~df.id.isin(min_check_pd.id.values)].minimum_nights.apply(lambda x:float(x)).mean()
        df.loc[df.id.isin(min_check_pd.id.values),"minimum_nights"] = int(average)
    ...
    def clean_number_of_reviews(df):
        ...
        #df.loc[df.id.apply(lambda x:x in min_check_pd.id.values),"number_of_reviews_flag"] = 1    
        average = df[~df.id.isin(min_check_pd.id.values)].number_of_reviews.apply(lambda x:float(x)).mean()
        df.loc[df.id.isin(min_check_pd.id.values),"number_of_reviews"] = int(average)
        return df
    ...
    def clean_last_reviews(df):
        ...
        df.loc[df.id.apply(lambda x:x in last_review_check_pd.id.values),"last_review_flag"] = 1    
